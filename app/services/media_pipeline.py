...
def download_audio_source(
    ...
    cmd = [
        ...
        "--newline",
        "--socket-timeout",
        str(max(5, settings.ytdlp_socket_timeout_seconds)),
        "--sleep-requests",
        str(max(0.0, settings.ytdlp_sleep_requests_seconds)),
        "--sleep-interval",
        str(max(0.0, settings.ytdlp_sleep_interval_seconds)),
        "--max-sleep-interval",
        str(max(settings.ytdlp_sleep_interval_seconds, settings.ytdlp_max_sleep_interval_seconds)),
